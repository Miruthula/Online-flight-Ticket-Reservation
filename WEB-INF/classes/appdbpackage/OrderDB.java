...
public class OrderDB {
    ...
    {       
     Connection connection = DbAdmin.getConnection();
        ...
        String query="INSERT into ncairlines.Order_Details(Flight_Number_Onward,Departure_Forward,Flight_Number_Return,"
    ...
    Connection connection = DbAdmin.getConnection();
        PreparedStatement ps;
        String query="select Arrival,Departure from ncairlines.Flight_Timing where Flight_Number='"+flightnum+"';";       
        //PreparedStatement ps;
    ...
    Connection connection = DbAdmin.getConnection();
        PreparedStatement ps;
        String query="select Price from ncairlines.Flight_Class_Price where Flight_Class='"+flightclass+"';";       
        //PreparedStatement ps;
        Search search=new Search();
        ResultSet resultset=null;
        int price=0;
