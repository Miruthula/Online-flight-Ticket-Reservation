...
"from \n" +"ncairlines.Flight_details_has_flight_price fdfp join ncairlines.flight_details fd on fdfp.Flight_Number=fd.Flight_Number\n" +
"join ncairlines.Flight_Class_Price fcp on fdfp.Flight_Class=fcp.Flight_Class\n" +
"join ncairlines.Flight_Timing ft on fd.Flight_Number=ft.Flight_Number\n" +
...
//            } else {
       ...
       public int checkavailability(String class1,String date,String dep_for,String flightnumber)
       {
        ...
        String a=date;
        int available=0;
        String query="select Total_seats from ncairlines.Flight_Class_Price where Flight_Class='"+class1+"'";
