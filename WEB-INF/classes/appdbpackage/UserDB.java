...
public class UserDB {
    ...
    public void adduser(Login login)
    {
        ...
        String query="INSERT into ncairlines.User_Details(UserID,FirstName,LastName,Gender,"
                    + "EmailAddress,SSN,Address,city,state,zipcode,Date_Of_birth,Phone_Number) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?)";
        String query1="Insert into ncairlines.Login_details(UserID,Password,Security_Ques1,Answer1) values(?,?,?,?)";
    ...
    public String getUser(String i) {
        ...
        String end_user ="";
        String query = "";
        query = "SELECT userID FROM ncairlines.User_Details where userID = '" + i + "'";
    ...
    public boolean CheckUser(String username,String Pwd) {
        ...
        boolean a = false;
        String query = "";
        query = "SELECT userID,Password FROM ncairlines.Login_details where userID = '" + username + "'";
       ...
       public int changeDetails(String userid,String emailaddress,String address,String city,String state,String zipcode,String phone)
    {
      ...
      {
        Login l=new Login();
        String query= "SELECT Role from ncairlines.Login_details where UserID='"+ userid +"'";
        Statement statement = DbAdmin.getNewStatement();
        ResultSet resultSet = null;
        int i=0;
       ...
       public int getUserRole(String userid) {
        ...
        int Role=0;
        String query = "";
        query= "SELECT Role from ncairlines.Login_details where UserID='"+ userid +"'";
