...
public class FlightDB {
     public void AddFlight(String flightnum,String source,String destination,String flighttype,String arrival,String departure) {
        ...
        try {
            ps1 = connection.prepareStatement("INSERT INTO ncairlines.flight_details(Flight_Number,Source,Destination,Flight_type) "
                    + "VALUES (?, ?, ?, ?)");
            ps1.setString(1, flightnum);
            ps1.setString(2, source);
            ps1.setString(3, destination);
            ps1.setString(4, flighttype);
            ps2 = connection.prepareStatement("INSERT INTO ncairlines.Flight_Timing(Flight_Number,Arrival,Departure) "
                    + "VALUES (?, ?, ?)");
      ...
      public String getFlight(String i, String j) {
       Connection connection = DbAdmin.getConnection();
        ...
        String item ="";
        String query = "";
        query = "SELECT "+i+" from ncairlines.flight_details where "+i+" = '"+j+"'";
      ...
      public FlightDetails getFlights(String j) {
        ...
        "from ncairlines.flight_details fd inner join fncairlines.Flight_Timing ft \n" +
     ...
     public void updateFlightDetails(String flightnumber,String source,String destination,
        ...
        query1 = "update ncairlines.flight_details fd join ncairlines.Flight_Timing ft on fd.Flight_Number = ft.Flight_Number set Source= ? ,Destination= ? , Flight_Type = ? , Arrival= ? ,Departure= ? "
      ...
      public void deleteFlightChild(String fno) {
        ...
        query = "Delete from ncairlines.Flight_Timing where Flight_Number  = '"+fno+"'";
     ...
     public void deleteFlightParent(String fno) {
        ...
        query = "Delete from ncairlines.flight_details where Flight_Number  = '"+fno+"'";
